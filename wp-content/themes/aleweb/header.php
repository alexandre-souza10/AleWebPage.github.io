...
<head>
    ...
    <link href="<?php echo get_theme_root_uri(); ?>/aleweb/style.css" rel="stylesheet">
</head>
...
<body>
    ...
    <section class="topo">
        <div class="center">
            <header>
                <div class="logo"><a href="<?php 'http://localhost/wordpress/' ?>"><img
                            src="<?php echo get_theme_root_uri(); ?>/aleweb/images/logo.png" />
                </div>
                <!--logo-->
            </header>
